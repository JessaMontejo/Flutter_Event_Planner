...
class Vieweditevent extends StatefulWidget {
  @override
  _ViewediteventState createState() => _ViewediteventState();
}

class _ViewediteventState extends State<Vieweditevent> {
  var loading = false;
  ...
  _delete(String id) async {
    final response = await http.post(
        "http://192.168.2.115/eventplanner/deleteevent.php",
        body: {"clientid": id});
    final data = jsonDecode(response.body);
